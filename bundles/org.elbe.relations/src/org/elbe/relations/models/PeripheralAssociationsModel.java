...
/** An associations model of an item that is not in the center of the RelationsView.
 *
...
implements IAssociationsModel {
    ...
    /** Factory method to create an instance of <code>PeripheralAssociationsModel</code>.
     *
     * @param inItem {@link IItemModel}
    ...
    /** Factory method to create an instance of <code>ExternalAssociationsModel</code>.
     *
    ...
    protected void afterSave() throws VException, SQLException {
        final CentralAssociationsModel center = this.browserManager.getCenterModel();

        // Check if we deleted the association with the central model
        if (this.removed.contains(center.getCenter().getUniqueID())) {
